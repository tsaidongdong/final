            ...
            for coin in scene_info["coins"]:
                    ...
                    if x < 140 and x > 5:
                        if y > 0 and y < 250:
                            ...
                            CoinPlace.add(4)            
            return move(grid= grid,CoinPlace=CoinPlace, speed_ahead = speed_ahead,left_space=left_space,middle_space=middle_space,right_space=right_space,self_x=self_x,self_y=self_y,CarSpeed=CarSpeed)
            
        def move(grid,CoinPlace, speed_ahead,left_space,middle_space,right_space,self_x,self_y,CarSpeed): 
            # if self.player_no == 0:
            #     print(grid)
            if left_space>middle_space and left_space>right_space:#left
                print("LeftSpace MODEL")
                if (1 in CoinPlace) or(2 in CoinPlace)or (3 in CoinPlace) or (4 in CoinPlace) or (5 in CoinPlace):#判斷四周金幣
                    if (1 in CoinPlace)or (4 in CoinPlace):
                        if(5 not in grid):#前方無緊急東西
                            if (1 not in grid) and (4 not in grid) and self_y+1>=0 and self_y+1<=10 and self_x-1>=0 and self_x-1<=8:
                                if  CarSpeed[self_y+1][self_x-1]<self.car_vel:
                                    return ["SPEED", "MOVE_LEFT"]
                            elif (1 in grid) and (4 not in grid) and self_y+1>=0 and self_y+1<=10 and self_x-1>=0 and self_x-1<=8:
                                if CarSpeed[self_y+1][self_x-1]<self.car_vel and CarSpeed[self_y-1][self_x-1]>self.car_vel:
                                    return ["SPEED","MOVE_LEFT"]
                            elif (1 in grid) and (4 not in grid) and self_y+1>=0 and self_y+1<=10 and self_x-1>=0 and self_x-1<=8:
                                if CarSpeed[self_y+1][self_x-1]<self.car_vel and CarSpeed[self_y-1][self_x-1]<self.car_vel:
                            ...
                            if (1 not in grid) and (4 not in grid) and self_y+1>=0 and self_y+1<=10 and self_x-1>=0 and self_x-1<=8: # turn left 
                                if CarSpeed[self_y+1][self_x-1]<self.car_vel:
                                    if self.car_vel < speed_ahead:
                                        return ["SPEED", "MOVE_LEFT"]
                                    else:
                                        return ["BRAKE", "MOVE_LEFT"]
                            elif (1 in grid) and (4 not in grid) and self_y+1>=0 and self_y+1<=10 and self_x-1>=0 and self_x-1<=8 and self_y-1>=0 and self_y-1<=10 :
                                if  CarSpeed[self_y+1][self_x-1]<self.car_vel and CarSpeed[self_y-1][self_x-1]>self.car_vel:
                                    if self.car_vel < speed_ahead:
                                        return ["SPEED", "MOVE_LEFT"]
                                    else:
                        ...
                        if len(grid) == 0:
                            ...
                            if (2 not in grid): # Check forward 
                                ...
                                if (6 not in grid) and (9 not in grid): # turn right
                                    return ["MOVE_RIGHT"]
                    elif (3 in CoinPlace)or (5 in CoinPlace):
                        if(5 not in grid):#前方無緊急東西
                            if (3 not in grid) and (6 not in grid) and self_y+1>=0 and self_y+1<=10 and self_x+1>=0 and self_x+1<=8:
                                if CarSpeed[self_y+1][self_x+1]<self.car_vel:
                                    return ["SPEED", "MOVE_RIGHT"]
                            elif (3 in grid) and (6 not in grid) and self_y+1>=0 and self_y+1<=10 and self_y-1>=0 and self_y-1<=10 and self_x+1>=0 and self_x+1<=8:
                                if CarSpeed[self_y+1][self_x+1]<self.car_vel and CarSpeed[self_y-1][self_x+1]>self.car_vel:
                                    return ["SPEED","MOVE_RIGHT"]
                            elif (3 in grid) and (6 not in grid) and self_y+1>=0 and self_y+1<=10 and self_y-1>=0 and self_y-1<=10 and self_x+1>=0 and self_x+1<=8:
                                if CarSpeed[self_y+1][self_x+1]<self.car_vel and CarSpeed[self_y-1][self_x+1]<self.car_vel:
                            ...
                            if (3 not in grid) and (6 not in grid) and self_y+1>=0 and self_y+1<=10 and self_x+1>=0 and self_x+1<=8:# turn right
                                if CarSpeed[self_y+1][self_x+1]<self.car_vel:
                                    if self.car_vel < speed_ahead:
                                        return ["SPEED", "MOVE_RIGHT"]
                                    else:
                ...
                if (1 in CoinPlace) or(2 in CoinPlace)or (3 in CoinPlace) or (4 in CoinPlace) or (5 in CoinPlace):#判斷四周金幣
                    if (3 in CoinPlace)or (5 in CoinPlace):
                        if(5 not in grid):#前方無緊急東西
                            if (3 not in grid) and (6 not in grid) and self_y+1>=0 and self_y+1<=10 and self_x+1>=0 and self_x+1<=8:
                                if CarSpeed[self_y+1][self_x+1]<self.car_vel:
                                    return ["SPEED", "MOVE_RIGHT"]
                        ...
                        if len(grid) == 0:
                            ...
                            if (2 not in grid): # Check forward 
                                ...
                                if (6 not in grid) and (9 not in grid): # turn right
                                    return ["MOVE_RIGHT"]
                    elif (1 in CoinPlace)or (4 in CoinPlace):
                        if(5 not in grid):#前方無緊急東西
                            if (1 not in grid) and (4 not in grid) and self_y+1>=0 and self_y+1<=10 and self_x-1>=0 and self_x-1<=8:
                                if  CarSpeed[self_y+1][self_x-1]<self.car_vel:
                                    return ["SPEED", "MOVE_LEFT"]
                    ...
                    if(2 in CoinPlace):
                        if len(grid) == 0:
                            ...
                            if (2 not in grid): # Check forward 
                                ...
                                if (6 not in grid) and (9 not in grid): # turn right
                                    return ["MOVE_RIGHT"]
                    if (1 in CoinPlace)or (4 in CoinPlace) and left_space>right_space :
                        if(5 not in grid):#前方無緊急東西
                            if (1 not in grid) and (4 not in grid) and self_y+1>=0 and self_y+1<=10 and self_x-1>=0 and self_x-1<=8:
                                if  CarSpeed[self_y+1][self_x-1]<self.car_vel:
                                    return ["SPEED", "MOVE_LEFT"]
                    ...
                    if self.car_pos[0]>315:#left
                        ...
                        if(5 not in grid):#前方無緊急東西
                            if (1 not in grid) and (4 not in grid) and self_y+1>=0 and self_y+1<=10 and self_x-1>=0 and self_x-1<=8:
                                if  CarSpeed[self_y+1][self_x-1]<self.car_vel:   
                                    return ["SPEED", "MOVE_LEFT"]
                            elif (1 in grid) and (4 not in grid) and self_y+1>=0 and self_y+1<=10 and self_y-1>=0 and self_y-1<=10 and self_x-1>=0 and self_x-1<=8:
                                if CarSpeed[self_y+1][self_x-1]<self.car_vel and CarSpeed[self_y-1][self_x-1]>self.car_vel:    
                                    return ["SPEED","MOVE_LEFT"]
                            elif (1 in grid) and (4 not in grid) and self_y+1>=0 and self_y+1<=10 and self_y-1>=0 and self_y-1<=10 and self_x-1>=0 and self_x-1<=8:
                                if CarSpeed[self_y+1][self_x-1]<self.car_vel and CarSpeed[self_y-1][self_x-1]<self.car_vel:
                ...
                if (1 in CoinPlace) or(2 in CoinPlace)or (3 in CoinPlace) or (4 in CoinPlace) or (5 in CoinPlace):#判斷四周金幣
                    ...
                    if self.car_pos[0]>350:#left
                        ...
                        if(5 not in grid):#前方無緊急東西
                            if (1 not in grid) and (4 not in grid) and self_y+1>=0 and self_y+1<=10 and self_x-1<=8 and self_x-1>=0 :
                                if  CarSpeed[self_y+1][self_x-1]<self.car_vel:
                                    return ["SPEED", "MOVE_LEFT"]
                            elif (1 in grid) and (4 not in grid) and self_y+1>=0 and self_y+1<=10 and self_y-1>=0 and self_y-1<=10 and self_x-1<=8 and self_x-1>=0 :
                                if  CarSpeed[self_y+1][self_x-1]<self.car_vel and CarSpeed[self_y-1][self_x-1]>self.car_vel:  
                                    return ["SPEED","MOVE_LEFT"]
                            elif (1 in grid) and (4 not in grid) and self_y+1>=0 and self_y+1<=10 and self_y-1>=0 and self_y-1<=10 and self_x-1<=8 and self_x-1>=0 :
                                if  CarSpeed[self_y+1][self_x-1]<self.car_vel and CarSpeed[self_y-1][self_x-1]<self.car_vel:   
                        ...
                        if(5 not in grid):#前方無緊急東西
                            ...
                            if (3 not in grid) and (6 not in grid) and self_y+1>=0 and self_y+1<=10 and self_x+1>=0 and self_x+1<=8:
                                if CarSpeed[self_y+1][self_x+1]<self.car_vel: # turn right
                                    if self.car_vel < speed_ahead:
                                        return ["SPEED", "MOVE_RIGHT"]
                                    else:
                                        return ["BRAKE", "MOVE_RIGHT"]
